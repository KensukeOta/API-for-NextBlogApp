...
RSpec.describe "Likes", type: :request do
  ...
  describe "POST /v1/likes" do
    ...
    it "creates a like for a post" do
      expect {
        post "/v1/likes", params: { like: { post_id: post_record.id } }, headers: headers
    ...
    it "returns not found if post does not exist" do
      expect {
        post "/v1/likes", params: { like: { post_id: "nonexistent" } }, headers: headers
      }.not_to change(Like, :count)
  ...
  describe "DELETE /v1/likes/:id" do
    ...
    it "deletes a like" do
      ...
      expect {
        delete "/v1/likes/#{like.id}", headers: headers
      }.to change(Like, :count).by(-1)
    ...
    it "does not delete another user's like" do
      ...
      expect {
        delete "/v1/likes/#{other_like.id}", headers: headers
      }.not_to change(Like, :count)
    ...
    it "returns not found if like does not exist" do
      expect {
        delete "/v1/likes/999999", headers: headers
      }.not_to change(Like, :count)
